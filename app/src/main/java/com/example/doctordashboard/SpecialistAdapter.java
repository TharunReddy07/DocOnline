...
public class SpecialistAdapter extends RecyclerView.Adapter<SpecialistAdapter.CardViewHolder> {
    ...
    ArrayList<SpecialistModel> CardLocations;
    RecyclerViewClickListener listener;

    public SpecialistAdapter(ArrayList<SpecialistModel> CardLocations, RecyclerViewClickListener listener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SpecialistAdapter.CardViewHolder holder, int position) {

        SpecialistModel cardHelperClass = CardLocations.get(position);
