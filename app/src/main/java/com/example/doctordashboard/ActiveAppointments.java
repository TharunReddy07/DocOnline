...
public class ActiveAppointments extends AppCompatActivity {
    ...
    private void Appointments() {
        ...
        FirebaseRecyclerOptions<ActiveAppointmentsModel> options =
                new FirebaseRecyclerOptions.Builder<ActiveAppointmentsModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("patients").child("tharun").child("active_app"),
                                ActiveAppointmentsModel.class)
                        .build();
